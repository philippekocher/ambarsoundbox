...
export const definition = {
  name: 'L:module_highpass',
  info: 'L:info_highpass',
  category: 'processor',
  inputs: {
    in: {},
    freq: { type: 'knob', label: 'L:freq', min: 20, max: 20000, value: 1000, curve: 1, uom: 'Hz'},
    Q: { type: 'knob', label: 'Q', min: 0.5, max: 10, value: 0.707, curve: 0.5 },
  },
  outputs: {
    out: {}
  }
...
export class Visualisation extends ModuleVisualisation {
  render() {
    ...
    const coeffs = calculateBiquadCoefficients('highpass', freq, q, sampleRate)
